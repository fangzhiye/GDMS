          ...
          <mu-paper>
            ...
            <div class="a-student" v-for="(student,sid) in  result.finalstudents">
              <div class="student-details">
                <mu-avatar :size="32" :icon="student.gender==='女'?'face':'mood'" :color="student.gender==='女'?'red500':'indigo500'" backgroundColor="#dedede"></mu-avatar><div class="student-name">{{student.name}} - {{student._id}}</div>
                <mu-divider/>
